...
<head>
    ...
    <script language="javascript">
        function kechengAll() {
            var strUrl = "<%=path%>/courseServlet?type=kechengAll";
        ...
        function laoshiAll() {
            var strUrl = "<%=path %>/teacherServlet?type=laoshiAll";
            var ret = window.showModalDialog(strUrl, "", "dialogWidth:700px; dialogHeight:500px; dialogLeft: status:no; directories:yes;scrollbars:yes;Resizable=no;");
            if (ret == undefined) {
                ret = "";
            }
...
<form action="<%=path %>/scheduleServlet?type=kebiaoAdd" name="formAdd" method="post">
